...
function t(e) {
    ...
    d(e, r, Math.min(t.highest_score, t.score)), c(e, t.score, r, 69), p(e), (0, f.drawText)({
        self: e,
        t: "游戏中存在可疑操作，该分数",
        pos: [ 207, 373 ],
        size: 17
...
function r(e) {
    e.imgid.bg++;
    var t = e.opt, r = e.context.bg;
    d(e, r, Math.min(t.highest_score, t.score))/*, (0, f.drawImageCenter)({
        self: e,
...
function o(e) {
    ...
    var t = e.opt, r = e.context.bg;
    if (d(e, r, Math.min(t.highest_score, t.score)), t.advertise && t.advertise.score ? (l(e, 244), 
    (0, f.drawText)({
        self: e,
        size: 14,
        t: "本次用时",
...
function n(e) {
    e.imgid.bg++, e.imgid.btn++;
    var t = e.opt, r = e.context.bg;
    d(e, r, Math.min(t.highest_score, t.score));
    var o = e.context.btn;
    ...
    (0, f.drawImageCenter)({
        ...
        cb: function() {
            ...
            r.fillRect((0, f.cx)(248), (0, f.cy)(162), (0, f.cwh)(9), (0, f.cwh)(3)), (0, f.drawText)({
                self: e,
                size: 14,
                t: "history" == e.opt.type ? "历史最快用时" : "本周最快用时",
                pos: [ 207, 160 ]
            }), (0, f.drawText)({
                self: e,
                size: 86,
...
function s(e, t) {
    var r = "新纪录", o = "#E11212";
    "history" == e.opt.type && (e.opt.highest_score >= 99999 && e.opt.score < 999999 ? (r = "初窥门径-建筑师", 
    o = "#509FC9") : e.opt.highest_score > 100 && e.opt.score <= 100 ? (r = "晋升-高级建筑师", 
    o = "#509FC9") : e.opt.highest_score > 70 && e.opt.score <= 70 ? (r = "晋升-建筑专家", 
    o = "#E67600") : e.opt.highest_score > 50 && e.opt.score <= 50  ? (r = "晋升-皇家建筑师", 
    o = "#009D5E") : e.opt.highest_score > 30 && e.opt.score <= 30 ? (r = "晋升-神匠", 
    o = "#7A0096") : e.opt.highest_score > 15 && e.opt.score <= 15 && (r = "晋升-鬼斧神工", 
    o = "#555555")), t.lineWidth = 1 * f.Dpr, t.strokeStyle = "#fff", t.fillStyle = "#fff", 
    (0, f.roundedRect)((0, f.cx)(166 - 20), (0, f.cy)(88), (0, f.cwh)(82 + 40), (0, f.cwh)(32), 4 * f.Dpr, t), 
    t.fill(), t.lineWidth = 1 * f.Dpr, t.strokeStyle = "#800000", t.fillStyle = "#800000", 
    (0, f.roundedRect)((0, f.cx)(169 - 20), (0, f.cy)(91), (0, f.cwh)(76 + 40), (0, f.cwh)(26), 2 * f.Dpr, t), 
    t.fill(), t.lineWidth = 1 * f.Dpr, t.strokeStyle = o, t.fillStyle = o, (0, f.roundedRect)((0, 
    f.cx)(169 - 20), (0, f.cy)(91), (0, f.cwh)(76 + 40), (0, f.cwh)(24), 2 * f.Dpr, t), t.fill(), 
    (0, f.drawText)({
        self: e,
        bold: !0,
        size: 14,
...
Object.defineProperty(exports, "__esModule", {
    ...
    e.myUserInfo = y.default.getMyUserInfo() || {
        headimg: "",
        nickname: "",
        week_best_score: 999999,
        score_info: [ {
            score: 999999
        } ]
    }, e.myUserInfo.last_week_best_score = s.week_best_score, e.myUserInfo.week_best_score = Math.min(s.week_best_score, s.score) || 999999;
    ...
    "tired" != e.opt.type && "skin" != e.opt.type && t > 168 - 40 && t < 340 - 40 && r > e.replayBtnPosy - 50 && r < e.replayBtnPosy + 50 ? ((0, 
    f.hide)(e), !!e.options.onClickReplay && e.options.onClickReplay(), !1) : "tired" == e.opt.type && e.noplay_time <= 0 && t > 207 - 40  && t < 360 - 40 && r > 540 && r < 660 ? (!!e.options.onClickReplay && e.options.onClickReplay(), 
...
var f = require("./base"), y = e(require("../../store/storage")),  w = require("../../config"), m = e(require("../threePage"));