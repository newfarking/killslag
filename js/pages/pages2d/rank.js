...
function t(e) {
    ...
    }),*/ t.canvasType == s.CANVASTYPE.friendRank ? 1 /*(0, s.drawImageCenter)({
        self: t,
...
var s = require("./base"), n = e(require("../../store/storage")), a = e(require("../../scroll/scrollHandler")),  l = require("../../config");
